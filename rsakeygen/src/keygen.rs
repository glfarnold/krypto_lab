pub mod keygen {
    ...
    // Implementierung des Miller Rabin Algorithmus
    ...
    // Funktion, die eine Primzahl einer ungefähren Bitlänge zurückgibt
    // für eine zufällige Zahl z wird (30+i)*z addiert mit den Primzahlen in primes und mit Miller Rabin 
    // auf Eigenschaften von Primzahlen getestet wird
    ...
    // RSA Key Generation 
    // aus der Eingabe p,q prim wird zunächst n = p*q und phi(n) berechnet 
    // der Teil des öffentlichen Schlüssels e wird als zufällige Primzahl kleiner phi(n) gewählt 
    // mit EUKLIDEX wird d, das multiplikative Inverse von e bzgl. phi(n) berechnet
    ...
    // dient zur Berechnung von d aus e und phi_n
    ...
    // erzeugt eine zufällige Zahl einer gewissen Bitlänge
